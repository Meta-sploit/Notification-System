...
public class FileController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get file attachment by ID")
    ...
    @Operation(summary = "Get all file attachments for a task")
    ...
    @Operation(summary = "Get pre-signed download URL for a file")
